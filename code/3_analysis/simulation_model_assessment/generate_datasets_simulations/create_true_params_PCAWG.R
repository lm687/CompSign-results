...
cov1 <- diag(exp(python_like_select_name(diagRE_params$`Kidney-ChRCC`$par.fixed, 'logs_sd_RE')))
lambdas <- python_like_select_name(diagRE_params$`Kidney-ChRCC`$par.fixed, 'log_lambda')
## lambdas: we don't save them but add them in the Snakemake code
exp(lambdas)
saveRDS(cov1, "/Users/morril01/Documents/PhD/GlobalDA/data/assessing_models_simulation/additional_files/multiple_fixed_covmatPCAWG1.RDS")
saveRDS(betas1[1,], "/Users/morril01/Documents/PhD/GlobalDA/data/assessing_models_simulation/additional_files/multiple_fixed_betainterceptPCAWG1.RDS")
saveRDS(betas1[2,], "/Users/morril01/Documents/PhD/GlobalDA/data/assessing_models_simulation/additional_files/multiple_fixed_betaslopePCAWG1.RDS")
## 7 log-ratios
median(rowSums(read_info_list$`Kidney-ChRCC`$dataset_active_sigs$Y)) ## median num of mutations
#---------------------------------------------------------------------------#
ct <- 'CNS-GBM'
fullDM_extra <- list()
...
saveRDS(cov2full, "/Users/morril01/Documents/PhD/GlobalDA/data/assessing_models_simulation/additional_files/multiple_fixed_covmatFULLPCAWG2.RDS")
...
saveRDS(diag(1,5), "/Users/morril01/Documents/PhD/GlobalDA/data/assessing_models_simulation/additional_files/multiple_fixed_covdiagd6.RDS")
...
#---------------------------------------------------------------------------#
flder_save <- '/Users/morril01/Documents/PhD/GlobalDA/data/assessing_models_simulation/additional_files/'
ct <- 'Lung-SCC'
ct <- 'Prost-AdenoCA'
