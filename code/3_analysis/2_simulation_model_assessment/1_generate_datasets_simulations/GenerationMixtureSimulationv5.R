...
t(sapply(c(1:n), function(id_patient){
  rmultinom(1, round(nlambda_vec[id_patient+length(sample_ids)]*props_mix[1]), normalise_rw(ct1[sample_ids[id_patient],]))+
    rmultinom(1, round(nlambda_vec[id_patient+length(sample_ids)]*props_mix[2]), normalise_rw(ct2[sample_ids[id_patient],]))
})))
