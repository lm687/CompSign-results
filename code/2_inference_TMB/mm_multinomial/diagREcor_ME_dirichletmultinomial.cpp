...
Type objective_function<Type>::operator() ()
{
  ...
  PARAMETER_VECTOR(logs_sd_RE); // not used here; the diagonal is zero
  ...
  // Sigma.diagonal() = vector<Type>(d_min1, 1);
  Sigma.diagonal() = logs_sd_RE; // bounded when nlminb is called
