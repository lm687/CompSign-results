// Equivalent to diagRE_ME_dirichletmultinomial.cpp but with patient-specific dispersion parameters lambda
...
Type objective_function<Type>::operator() ()
{
  ...
  PARAMETER_MATRIX(log_lambda); // log of the parameter for overdispersion in Dirichlet-Multinomial model (n values, one for each group and patient)
  int d_min1 = d - 1;
  ...
  log_lambda_vec = z * log_lambda; // get a vector of lambdas of length 2*n
